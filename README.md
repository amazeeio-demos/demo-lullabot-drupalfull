...
1. Checkout this project repo and confirm the path is in Docker's file sharing config - https://docs.docker.com/docker-for-mac/#file-sharing
    ...
    ```bash
    git clone https://github.com/amazeeio-sales/demo-lullabot-drupalfull.git demo-lullabot-drupalfull && cd $_
    ```
...
4. Visit the new site @ `http://demo-lullabot-drupalfull.docker.amazee.io`
...
6. Visit the new site @ `http://demo-lullabot-drupalfull.lndo.site`
